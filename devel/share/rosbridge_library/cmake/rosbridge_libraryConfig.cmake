...
if("TRUE" STREQUAL "TRUE")
  set(rosbridge_library_SOURCE_PREFIX /home/rosbox/catkin_ws/src/rosbridge/rosbridge_suite/rosbridge_library)
  set(rosbridge_library_DEVEL_PREFIX /home/rosbox/catkin_ws/devel)
  ...
  set(rosbridge_library_INSTALL_PREFIX /home/rosbox/catkin_ws/install)
...
if(NOT "/home/rosbox/catkin_ws/devel/include" STREQUAL "")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'rosbridge_library' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/rosbox/catkin_ws/src/rosbridge/rosbridge_suite/rosbridge_library/${idir}'.  Ask the maintainer 'Russell Toris <rctoris@wpi.edu>, Jihoon Lee <jihoonlee.in@gmail.com>' to fix it.")
    endif()
