...
if("TRUE" STREQUAL "TRUE")
  set(stereo_image_proc_SOURCE_PREFIX /home/rosbox/catkin_ws/src/image_pipeline/stereo_image_proc)
  set(stereo_image_proc_DEVEL_PREFIX /home/rosbox/catkin_ws/devel)
  ...
  set(stereo_image_proc_INSTALL_PREFIX /home/rosbox/catkin_ws/install)
...
if(NOT "/home/rosbox/catkin_ws/devel/include;/home/rosbox/catkin_ws/src/image_pipeline/stereo_image_proc/include" STREQUAL "")
  set(stereo_image_proc_INCLUDE_DIRS "")
  set(_include_dirs "/home/rosbox/catkin_ws/devel/include;/home/rosbox/catkin_ws/src/image_pipeline/stereo_image_proc/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'stereo_image_proc' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/rosbox/catkin_ws/src/image_pipeline/stereo_image_proc/${idir}'.  Ask the maintainer 'Vincent Rabaud <vincent.rabaud@gmail.com>' to fix it.")
    endif()
