...
if("TRUE" STREQUAL "TRUE")
  set(image_proc_SOURCE_PREFIX /home/rosbox/catkin_ws/src/image_pipeline/image_proc)
  set(image_proc_DEVEL_PREFIX /home/rosbox/catkin_ws/devel)
  ...
  set(image_proc_INSTALL_PREFIX /home/rosbox/catkin_ws/install)
...
if(NOT "/home/rosbox/catkin_ws/devel/include;/home/rosbox/catkin_ws/src/image_pipeline/image_proc/include;/opt/ros/hydro/include/opencv;/opt/ros/hydro/include" STREQUAL "")
  set(image_proc_INCLUDE_DIRS "")
  set(_include_dirs "/home/rosbox/catkin_ws/devel/include;/home/rosbox/catkin_ws/src/image_pipeline/image_proc/include;/opt/ros/hydro/include/opencv;/opt/ros/hydro/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'image_proc' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/rosbox/catkin_ws/src/image_pipeline/image_proc/${idir}'.  Ask the maintainer 'Vincent Rabaud <vincent.rabaud@gmail.com>' to fix it.")
    endif()
    _list_append_unique(image_proc_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "image_proc;/opt/ros/hydro/lib/libopencv_core.so.2.4.9;/opt/ros/hydro/lib/libopencv_highgui.so.2.4.9;/opt/ros/hydro/lib/libopencv_imgproc.so.2.4.9")
