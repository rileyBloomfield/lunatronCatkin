...
if("TRUE" STREQUAL "TRUE")
  set(uvc_camera_SOURCE_PREFIX /home/rosbox/catkin_ws/src/camera_umd/uvc_camera)
  set(uvc_camera_DEVEL_PREFIX /home/rosbox/catkin_ws/devel)
  ...
  set(uvc_camera_INSTALL_PREFIX /home/rosbox/catkin_ws/install)
...
if(NOT "" STREQUAL "")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'uvc_camera' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/rosbox/catkin_ws/src/camera_umd/uvc_camera/${idir}'.  Ask the maintainer 'Ken Tossell <ken@tossell.net>' to fix it.")
    endif()
